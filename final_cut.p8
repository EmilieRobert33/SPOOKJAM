...
function draw_cut()
 cls(1)
 ------------------------
 print("was it all just a dream?",cam_x+20,cam_y+30,7)
 print("game over",cam_x+46,cam_y+90,7)
 spr(105,cam_x+64-16,cam_y+48,4,2)
 if (cos(t())<0) then
  spr(97,cam_x+64-16,cam_y+48+16,4,2)
 else
  spr(101,cam_x+64-16,cam_y+48+16,4,2)
 end
 paup()
end
...
function draw_gene()
 --cls(6)
  cls()
  print("thank you",30+15+cam_x,gene+cam_y,7)
  print("for playing",30+11+cam_x,gene+10+cam_y,7)
  print("game made by",30+10+cam_x,gene+20+cam_y,7)
  print("gascoun gaming",30+7+cam_x,gene+30+cam_y,7)
  print("art and music:",30+7+cam_x,gene+40+cam_y,7)
  print("kaioken",30+17+4+cam_x,gene+50+cam_y,7)
  print("code :",30+19+4+cam_x,gene+60+cam_y,7)
  print("ph0enix",30+17+4+cam_x,gene+70+cam_y,7)
  print("naw4k",30+21+4+cam_x,gene+80+cam_y,7)
  --print("retry: x/❎",30+14+cam_x,gene+90+cam_y,7)
end
...
function player_update()
 ...
 --if (btnp(5)) detect_fait_fantome()
	...
	--if (p.jump == 2) then
		--p.jump_mask = 2
	--end
	--if ((p.x>=51*8 and p.x<=52*8) and (p.y<=61*8 and p.y>=62*8)) p.score=3
...
function paup()
 ...
 if (fc<=64 and oeil==true) then
  fc+=0.25
  rectfill(cam_x,cam_y,cam_x+128,cam_y+0+fc,0)
  rectfill(cam_x,cam_y+128,cam_x+128,cam_y+128-fc,0)
  if (fc>64) then 
   oeil=false
...

...

...
05000000000500000000000000000000000000000005053535353535353535353535353535353535353535353535353535353535350535353535353535353535
...

...

...

...

...

